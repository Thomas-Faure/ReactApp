    ...
    <div className="columns">
      ...
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="field">
            <label className="label"><FormattedMessage id="backoffice.menu1.users.create.password"/> <strong style={{color: "red"}}>empty to avoid modification</strong></label>
            <div className="control">
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProps)(BackOfficeEditUser));
